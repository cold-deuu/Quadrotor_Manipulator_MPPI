...
if("TRUE" STREQUAL "TRUE")
  set(rotors_evaluation_SOURCE_PREFIX /home/chan/aerial_ws/src/rotors_simulator/rotors_evaluation)
  set(rotors_evaluation_DEVEL_PREFIX /home/chan/aerial_ws/src/build/devel)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rotors_evaluation' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/chan/aerial_ws/src/rotors_simulator/rotors_evaluation/${idir}'.  ${_report}")
    endif()
